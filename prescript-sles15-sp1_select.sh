...
cat > susemanager-addon-cd << EOF
 <add-on>
   <add_on_products config:type="list">
    <listentry>
     <media_url>http://sumacka01.ckalab.suse.com/pub/distribution/sle-15-sp1-packages/dvd1/</media_url>
     <product>sle-module-basesystem</product>
     <product_dir>Module-Basesystem</product_dir>
    </listentry>
    <listentry>
      <ask_on_error config:type="boolean">true</ask_on_error>
      <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/@@SUMACHANNEL@@-sle-product-sles15-sp1-updates-x86_64/@@SUMACHANNEL@@</media_url>
      <name>@@SUMACHANNEL@@-sle-product-sles15-sp1-updates_channel</name>
      <product>@@SUMACHANNEL@@-sle-product-sles15-sp1-updates_channel</product>
      <product_dir>/</product_dir>
    </listentry>
    <listentry>
      <ask_on_error config:type="boolean">true</ask_on_error>
      <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/@@SUMACHANNEL@@-sle-module-basesystem15-sp1-updates-x86_64/@@SUMACHANNEL@@</media_url>
      <name>@@SUMACHANNEL@@-sle-module-basesystem15-sp1-updates_channel</name>
      <product>@@SUMACHANNEL@@-sle-module-basesystem15-sp1-updates_channel</product>
      <product_dir>/</product_dir>
    </listentry>
    <listentry>
      <ask_on_error config:type="boolean">true</ask_on_error>
      <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/@@SUMACHANNEL@@-sle-module-server-applications15-sp1-pool-x86_64/@@SUMACHANNEL@@</media_url>
      <name>@@SUMACHANNEL@@-sle-module-server-applications15-sp1-pool_channel</name>
      <product>@@SUMACHANNEL@@-sle-module-server-applications15-sp1-pool_channel</product>
      <product_dir>/</product_dir>
    </listentry>
    <listentry>
      <ask_on_error config:type="boolean">true</ask_on_error>
      <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/@@SUMACHANNEL@@-sle-module-server-applications15-sp1-updates-x86_64/@@SUMACHANNEL@@</media_url>
      <name>@@SUMACHANNEL@@-sle-module-server-applications15-sp1-updates_channel</name>
      <product>@@SUMACHANNEL@@-sle-module-server-applications15-sp1-updates_channel</product>
      <product_dir>/</product_dir>
    </listentry>
    <listentry>
      <ask_on_error config:type="boolean">true</ask_on_error>
      <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/@@SUMACHANNEL@@-sle-manager-tools15-updates-x86_64-sp1/@@SUMACHANNEL@@</media_url>
      <name>@@SUMACHANNEL@@_suse_manager_tools_update_channel</name>
      <product>@@SUMACHANNEL@@_suse_manager_tools_update_channel</product>
      <product_dir>/</product_dir>
    </listentry>
    </add_on_products>
  </add-on>
  ...
  <add-on>
    <add_on_products config:type="list">
      <listentry>
        <ask_on_error config:type="boolean">true</ask_on_error>
        <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/@@SUMACHANNEL@@-sle-product-sles15-sp1-updates-x86_64/@@SUMACHANNEL@@</media_url>
        <name>@@SUMACHANNEL@@-updates_channel</name>
        <product>@@SUMACHANNEL@@-updates_channel</product>
        <product_dir>/</product_dir>
        </listentry>
    </add_on_products>
  </add-on>
...
sed -i '/ask-list/,/ask-list/d' /tmp/profile/modified-software.xml
