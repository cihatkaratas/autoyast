...
<add-on>
  ...
  <listentry>
    ...
    <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/@@SUMACHANNEL@@-sles12-sp4-updates-x86_64/@@SUMACHANNEL@@</media_url>
    <name>@@SUMACHANNEL@@_installation_update_channel</name>
    <product>@@SUMACHANNEL@@_installation_update_channel</product>
    <product_dir>/</product_dir>
  </listentry>
  <listentry>
    <ask_on_error config:type="boolean">true</ask_on_error>
    <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/@@SUMACHANNEL@@-sle-module-containers12-pool-x86_64-sp4/@@SUMACHANNEL@@</media_url>
    <name>@@SUMACHANNEL@@_container_module_pool_channel</name>
    <product>@@SUMACHANNEL@@_container_module_pool_channel</product>
    <product_dir>/</product_dir>
  </listentry>
  <listentry>
    <ask_on_error config:type="boolean">true</ask_on_error>
    <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/@@SUMACHANNEL@@-sle-module-containers12-updates-x86_64-sp4/@@SUMACHANNEL@@</media_url>
    <name>@@SUMACHANNEL@@_container_module_update_channel</name>
    <product>@@SUMACHANNEL@@_container_module_pool_channel</product>
    <product_dir>/</product_dir>
  </listentry>
  <listentry>
    <ask_on_error config:type="boolean">true</ask_on_error>
    <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/@@SUMACHANNEL@@-sle-manager-tools12-updates-x86_64-sp4/@@SUMACHANNEL@@</media_url>
...
cat > susemanager-addon-cd << EOF
  <add-on>
    ...
    <listentry>
      <ask_on_error config:type="boolean">true</ask_on_error>
      <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/@@SUMACHANNEL@@-sles12-sp4-updates-x86_64/@@SUMACHANNEL@@</media_url>
      <name>@@SUMACHANNEL@@-sles12-sp4_installation_update_channel</name>
      <product>@@SUMACHANNEL@@-sles12-sp4_installation_update_channel</product>
      <product_dir>/</product_dir>
    </listentry>
    </add_on_products>
  </add-on>
