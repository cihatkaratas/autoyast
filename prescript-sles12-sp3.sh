...
cat > susemanager-addon-cd << EOF
  <add-on>
    ...
    <listentry>
      ...
      <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/dc1-sles12-sp3-prod-sles12-sp3-updates-x86_64/dc1-sles12-sp3-prod</media_url>
      <name>dc1-sles12-sp3-prod_installation_update_channel</name>
      <product>dc1-sles12-sp3-prod_installation_update_channel</product>
      <product_dir>/</product_dir>
    </listentry>
    <listentry>
      <ask_on_error config:type="boolean">true</ask_on_error>
      <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/dc1-sles12-sp3-prod-sle-module-containers12-pool-x86_64-sp3/dc1-sles12-sp3-prod</media_url>
      <name>dc1-sles12-sp3-prod_container_module_pool_channel</name>
      <product>dc1-sles12-sp3-prod_container_module_pool_channel</product>
      <product_dir>/</product_dir>
    </listentry>
    <listentry>
      <ask_on_error config:type="boolean">true</ask_on_error>
      <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/dc1-sles12-sp3-prod-sle-module-containers12-updates-x86_64-sp3/dc1-sles12-sp3-prod</media_url>
      <name>dc1-sles12-sp3-prod_container_module_update_channel</name>
      <product>dc1-sles12-sp3-prod_container_module_pool_channel</product>
      <product_dir>/</product_dir>
    </listentry>
    <listentry>
      <ask_on_error config:type="boolean">true</ask_on_error>
      <media_url>http://sumacka01.ckalab.suse.com/ks/dist/child/dc1-sles12-sp3-prod-sle-manager-tools12-updates-x86_64-sp3/dc1-sles12-sp3-prod</media_url>
      <name>dc1-sles12-sp3-prod_suse_manager_tools_update_channel</name>
      <product>dc1-sles12-sp3-prod_suse_manager_tools_update_channel</product>
      <product_dir>/</product_dir>
    </listentry>
    </add_on_products>
  </add-on>
